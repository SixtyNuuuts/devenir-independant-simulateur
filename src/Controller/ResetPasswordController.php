...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(Request $request, MailerInterface $mailer, TranslatorInterface $translator): Response
    {
        ...
        if (!\is_string($formEmail)) {
            throw new BadRequestHttpException('L\'Email doit être une chaîne de caractères.');
        }

        if (empty($formEmail)) {
            throw new BadRequestHttpException('L\'Email ne peut pas être vide.');
        }
