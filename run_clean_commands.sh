...
$PHP_BIN -d memory_limit=1024M -d display_errors=on $PROJECT_DIR/bin/console app:clean-simulations
$PHP_BIN -d memory_limit=1024M -d display_errors=on $PROJECT_DIR/bin/console app:clean-anonymous-users
