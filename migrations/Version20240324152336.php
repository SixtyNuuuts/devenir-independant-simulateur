 ...
 */
final class Version20240324152336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE anonymous_user (id BIGINT AUTO_INCREMENT NOT NULL, session_id VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE simulation (id INT AUTO_INCREMENT NOT NULL, activity_id INT NOT NULL, user_id INT DEFAULT NULL, anonymous_user_id BIGINT DEFAULT NULL, token VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', target_salary NUMERIC(10, 2) NOT NULL, INDEX IDX_CBDA467B81C06096 (activity_id), INDEX IDX_CBDA467BA76ED395 (user_id), INDEX IDX_CBDA467B52656F32 (anonymous_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
